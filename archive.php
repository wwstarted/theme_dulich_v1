<?php
/**
 * WANDERLAND — archive.php
 * Blog archive: filter + grid + pagination
 */
...
if (isset($_GET['cat']) && intval($_GET['cat'])) {
    ...
    // Vào từ URL /category/slug/ → tự detect category hiện tại
    $queried_cat = get_queried_object();
    $current_cat = $queried_cat ? $queried_cat->term_id : 0;
} else {
    $current_cat = 0;
}
...
if (is_category() && !isset($_GET['cat'])) {
    // Đang ở /category/slug/ → base về trang blog chính
    ...
    <div class="wl-archive-page-header">
        <div class="wl-archive-container">
            ...
            <nav class="wl-archive-breadcrumb" aria-label="<?php esc_attr_e('Breadcrumb', 'wanderland'); ?>">
                ...
                <a href="<?php echo esc_url($base_url); ?>"><?php esc_html_e('Blog', 'wanderland'); ?></a>
                <span class="wl-bc-sep" aria-hidden="true">/</span>
                <span><?php echo esc_html($filter_cat_obj->name); ?></span>
                <?php else: ?>
                <span><?php esc_html_e('Blog', 'wanderland'); ?></span>
                <?php endif; ?>
            </nav>

            <!-- Title -->
            <h1 class="wl-archive-page-title"><?php echo esc_html($page_title); ?></h1>
            <?php if ($page_desc): ?>
            <p class="wl-archive-page-desc"><?php echo esc_html($page_desc); ?></p>
            <?php endif; ?>
            ...
            <div class="wl-archive-filter-bar">
                ...
                <div class="wl-filter-cats">
                    ...
                    <a class="wl-filter-cat <?php echo $current_cat === $cat_item->term_id ? 'is-active' : ''; ?>" href="<?php echo esc_url(add_query_arg(
                        ...
                        <span class="wl-filter-count"><?php echo intval($cat_item->count); ?></span>
                    </a>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="wl-filter-controls">
                    ...
                    <div class="wl-filter-select-wrap">
                        <select class="wl-filter-select"
                            ...
                            <option value=""><?php esc_html_e('All Years', 'wanderland'); ?></option>
    ...
    <div class="wl-archive-container wl-archive-body">
        ...
        <div id="wl-ajax-wrap" data-current-page="<?php echo esc_attr($paged); ?>"
            ...
            <div class="wl-archive-empty">
                ...
                <h3 class="wl-archive-empty-title"><?php esc_html_e('No posts found', 'wanderland'); ?></h3>
